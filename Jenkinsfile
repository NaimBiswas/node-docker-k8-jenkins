pipeline {
    ...
    environment {
        GCR_CREDENTIALS = credentials('gcr-credentials-id') // Your GCR credentials ID in Jenkins
    ...
    stages {
        stage('Clone repository') {
            steps {
                git branch: 'main', url: 'https://github.com/your-repo.git' // Your GitHub repository URL
            }
        }
